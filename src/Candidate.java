class Candidate implements Comparable<Candidate> {
	...
	// weights => Linear Combination will be considered!
	double centrality;
	double position;
	double length;
	...
	public String toString() {
		return "Chromosome:" + chromosome + "Fitness:" + Fit + "Length:"
				+ length + "Position:" + position + "Title Resemblance:"
				+ titleSimilarity + "Num Data:" + NumData;
	}

	public int compareTo(Candidate o) {
		if (GA.flag == 1)
			return Double.compare(this.Fit, o.Fit);
